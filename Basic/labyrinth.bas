...
1638 SM=SC+LL*12+18-H+LL*V+2*X-(LL*2)*Y
1640 IF X6=0 THEN POKE SM,102
1645 IF X6=1 THEN VPOKE 0,SM,5: VPOKE 0,SM+1,$66
...
10200 IF X6=1 THEN LL=256
10210 IF X6=0 THEN LL=40
10220 IF X6=1 THEN SCREEN($00): REM SET X16 TO 40X30 MODE
10900 RETURN
