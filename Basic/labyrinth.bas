...
1540 REM PRINT CHR$($93): REM THIS CLEARS THE SCREEN - NO TIME TO SEE
...
1640 POKE SC+LL*12+18-H+LL*V+2*X-(LL*2)*Y,102: REM DRAW AN ARROW ON SCREEN
1645 IF X6=1 THEN VPOKE SC++LL*12+18-H+LL*V+2*X-(LL*2)*Y,10
...
2470 IF Y=C0 THEN PRINT CHR$($1D) CHR$($12) MID$(W$,(IANDC1)+C1,C8);:GOTO 2520
...
2725 REM DRAW CENTER FLOOR AND LEFT AND RRIGHT FLOOR
2730 IF ER=C0 THEN PRINT CHR$($12)CHR$($CD)CHR$($A3)CHR$($A3)CHR$($A3)CHR$($A3);
2731 IF ER=C0 THEN PRINT CHR$($A3)CHR$($A3)CHR$($A3):GOTO 2760
...
2900 IF I=C1 THEN PRINT:GOTO2930
2910 IF ER=C1 THEN PRINT CHR$($A4)CHR$($A4)CHR$($A4)CHR$($A4):GOTO2930
2920 PRINT CHR$($A4)
2930 NEXT
2940 FOR I=C1 TO 15
2941 PRINT Z$;
...
3010 IF D=C1 THEN PRINT CHR$($A5):GOTO3060
3015 REM DRAW CENTER PASSAGE AND PASSAGE TO RIGHT
3020 IF ER=C1 THEN PRINT CHR$($12)CHR$($A6)CHR$($A6)CHR$($A6)CHR$($A6):GOTO 3060
3030 IF I=C3 THEN PRINT CHR$($12)CHR$($A6)CHR$($92);
3031 IF I=C3 THEN PRINT CHR$($A4)CHR$($A4)CHR$($A4):GOTO 3060
3040 IF I>12THEN PRINT CHR$($12)CHR$($A6)"   ":GOTO 3060
...
3170 IF ER=C0 THEN PRINT CHR$($12)CHR$($CD)CHR$($A3)CHR$($A3)CHR$($A3):GOTO 3200
...
4010 IF I=C1 THEN PRINT CHR$($12)CHR$($A6)CHR$($92) CHR$($A4):GOTO4040
